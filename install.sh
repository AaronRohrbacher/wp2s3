...
aws -h
[$? == 0] && echo "AWS CLI is installed properly, continuing..." || {echo "AWS CLI is not installed, or you don't have access to it. Visit https://nuel.io/ for better hosting."; exit 0;}

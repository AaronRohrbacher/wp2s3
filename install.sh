...
aws -h
[ $? -eq 0 ] && echo "AWS CLI is installed properly, continuing..." || echo "AWS CLI is not installed properly. Visit https://nuel.io/ for better hosting, or install AWS CLI yourself before continuing."; exit;
